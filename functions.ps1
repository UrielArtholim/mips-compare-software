########################################################
# Fichero de funciones importadas a Windows Powershell #
# Fichero que contiene las funciones no nativas        # 
# para mantener una mayor limpieza del código          #
...
########################################################
# 1. Función Get-IniContent                            #
# Función que permite importar información de archivos #
...
########################################################
# 2. Función Out-IniFile                               #
# Función que permite crear un nuevo fichero           #
# de configuración .ini                                #
########################################################
...
########################################################
# 3. Función Exportar-CSV                              #
# Función que permite introducir los                   #
# resultados de los ejercicios en un fichero CSV       #
########################################################